...
<html>
    ...
    <body>
        ...
        <!-- CONTENIDO -->
        <p style="margin-left: 10%">Actualiza la URL para editar la cantidad de n&uacute;meros a generar</p>
        <p style="margin-left: 10%">Ejemplo: http://localhost:8080/JSP_JuarezBarrios/jsp1.jsp?numero=1</p> <br>
        ...
        %>
        <h4 style="margin-left: 20%"><%=arreglo[i] %></h4>
        <%
                }
            }
            else {
